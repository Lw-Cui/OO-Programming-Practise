...
Class.prototype.assginLeader = function(student) {
	if (student._class == this) {
		...
		for (var i in this._teacher)
			return this._teacher[i].informLeader(this, student);
	} else {
...
Class.prototype.appendMember = function(student) {
	...
	for (var i in this._teacher)
		return this._teacher[i].informJoin(this, student);
};
...
var Teacher = function(age, name, my_classes) {
	...
	for (var i in this._classes)
		this._classes[i]._teacher.push(this);
};
...
Teacher.prototype.informJoin = function(myclass, student) {
	return "I am " + this._name + ". I know " + student._name + " has joined Class " + myclass._number + ".";
};

Teacher.prototype.informLeader = function(myclass, student) {
	return "I am " + this._name + ". I know " + student._name + " become Leader of Class " + myclass._number + ".";
};